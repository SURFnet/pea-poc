<template>
    <PageContainer>
        <PageHeader :title="trans('page.information-manager.custom-tool.create.heading')" />
...
import ToolForm from '@/pages/content-manager/tool/components/ToolForm.vue';
    ...
    methods: {
        ...
        submit(props = { continueEditing: false }) {
            ...
            this.form
                ...
                .post(route('information-manager.custom-tool.store', postArguments), {
