<template>
    <div class="container-xl">
        ...
        <PageContainer>
            <PageCard>
                ...
                <form @submit.prevent="submitAndContinue">
                    ...
                    <FormFooter class="flex justify-between mt-6">
                        <Btn
                            target="_blank"
                            :href="route('information-manager.custom-tool.log', { tool: tool.slug })"
                            variant="default"
                        >
            ...
            <OriginalToolInfo
                :tool="tool"
                :text="trans('page.our.tool.show.tool_information')"
            />
        </PageContainer>
    </div>
</template>
    ...
    methods: {
        ...
        submit(props = { continueEditing: false }) {
            ...
            this.form
                ...
                .post(route('information-manager.custom-tool.information.update', postArguments), {
        ...
        unpublish() {
            ...
            this.form.post(route('information-manager.custom-tool.information.unpublish', this.tool), {
                onError: this.showFirstFormError,
            });
        },
        /**
        ...
        publish() {
            ...
            this.form.post(route('information-manager.custom-tool.information.publish', this.tool), {
                onError: this.showFirstFormError,
            });
        },
        /** @returns {void} */
        cancel() {
            router.post(route('information-manager.custom-tool.information.cancel-edit', this.tool));
        },
    },
    /**
