    ...
    methods: {
        ...
        submit(props = { continueEditing: false }) {
            ...
            this.form
                ...
                .post(route('information-manager.custom-tool.update', postArguments), {
        ...
        publish() {
            this.form
                ...
                .post(route('information-manager.custom-tool.publish', this.tool), {
                    // eslint-disable-next-line vue/no-undef-properties
                    onError: this.showFirstFormError,
                });
        },
        /** @returns {void} */
        cancel() {
            router.post(route('information-manager.custom-tool.cancel-edit', this.tool));
        },
    },
    /**
